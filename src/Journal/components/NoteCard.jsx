...
import { setActiveNote, startDeletingNote, updateMessageSave } from "../../store/journal";
...
export const NoteCard = ({...note}) => {
    ...
    const onDeleteNote = () => {
        ...
        setTimeout(()=>{ dispatch(updateMessageSave(null))}, 5000)
    }
    ...
    return (
        <article className=" border shadow-md rounded-md" >
                ...
                <div className=" border-t  border-indigo-300  flex justify-between ">
                    <button className=" text-red-500 w-full p-2 border-r   border-indigo-300 rounded-bl-[3px] hover:bg-red-400 hover:text-white" onClick={onDeleteNote}>Eliminar</button>
